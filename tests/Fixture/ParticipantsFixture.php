...
class ParticipantsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'type2' => ['type' => 'string', 'fixed' => true, 'length' => 1, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null],
    ...
    public $records = [
        [
            ...
            'validate' => 1,
            'created' => '2019-09-22 20:01:35',
            'modified' => '2019-09-22 20:01:35',
            'created_by' => 1,
            'modified_by' => 1
        ],
    ];

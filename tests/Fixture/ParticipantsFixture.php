...
class ParticipantsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'qr' => ['type' => 'string', 'length' => 240, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'validate' => 1,
            'created' => '2019-12-04 01:49:09',
            'modified' => '2019-12-04 01:49:09',
            'created_by' => 1,
            'modified_by' => 1
        ],
    ];

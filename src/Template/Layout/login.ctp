...
<body class="hold-transition login-page">
    <div class="login-box">
        <div class="login-logo">
            <a href="<?php echo $this->Url->build(array('controller' => 'pages', 'action' => 'display', 'home')); ?>"><?php echo Configure::read('Theme.title'); ?></a>
        </div>
        <div class="row">
        ...
        <div class="login-box-body">
            <p class="login-box-msg text-primary"><?php echo __('Introduce sus datos para iniciar sesión') ?></p>
